...
class HomeNewsBlockController extends BlockController {
	...
	protected $btName = 'Home news';
	protected $btDescription = '';
	protected $btTable = 'btDCHomeNews';
	...
	public function getSearchableContent() {
		return $this->field_2_textbox_text;
	}

	public function view() {
		$this->set('field_1_image', (empty($this->field_1_image_fID) ? null : $this->get_image_object($this->field_1_image_fID, 60, 60, true)));
	}
